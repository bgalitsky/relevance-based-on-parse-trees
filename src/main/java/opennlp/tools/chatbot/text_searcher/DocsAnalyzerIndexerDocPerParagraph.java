...
public class DocsAnalyzerIndexerDocPerParagraph {
	public static String resourceDir = ExtractedQaPairsIndexer.resourceDir;
	public static String INDEX_PATH = "/docIndexPerPara";
	...
	public DocsAnalyzerIndexerDocPerParagraph() {
	...
	public static void main(String[] args) {
		DocsAnalyzerIndexerDocPerParagraph indexer =  new DocsAnalyzerIndexerDocPerParagraph();
