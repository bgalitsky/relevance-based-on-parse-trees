...
public class QnAPairsChatBotWrapper extends SearchSessionManagerWrapper {
...
/*				else if (queryType == 3 && AnaphoraProcessor.isAnaphoraQuery(query)){
	...
	protected BotResponse runBasicSearch(String query, BotResponse resp){
		...
		if (clarificationStr==null){ 
			...
			if (clarificationPair.getSecond().size()>1)
				resp.responseMessage = "These are the main topics of your query: Please select \n"+ 
					clarificationStr;
			else 
				resp.responseMessage = "I believe this is the topic of your query: Please confirm \n"+ 
						clarificationStr;
	...
	public static void main(String[] args){	
		QnAPairsChatBotWrapper wrapper = new QnAPairsChatBotWrapper();
