...
public class TopicExtractorFromSearchResultRstMatcher {
	private static MatcherExternalRST matcher;
	...
	public TopicExtractorFromSearchResultRstMatcher(MatcherExternalRST matcherFromTK) {
	    matcher =matcherFromTK;
    }

	public TopicExtractorFromSearchResultRstMatcher() {
	    matcher = new MatcherExternalRST();
    }
