...
public class LongQueryWebSearcher {
	...
	private static LongQueryWebSearcher  instance;
	public synchronized static LongQueryWebSearcher  getInstance() {
	    if (instance == null)
	      instance = new LongQueryWebSearcher ();

	    return instance;
	  }
	
	public TopicExtractorFromSearchResult getPhraseExtractor(){
		return extractor;
	}
